const config = {
    ...
    deploymentConfigFile: 'bean-machine-deployment.json',

    // For smart contract deployment on testnet
    infuriaProjectId: '$$INFURIA_PROJECT_ID',

    // The name of the token contract
    deploymentContractName: 'DarkSoulToken',

    // A short symbol for the tokens in this contract
    deploymentContractSymbol: 'DST',
